...
public class JavaliParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(JavaliParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(JavaliParser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaliListener ) ((JavaliListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaliListener ) ((JavaliListener)listener).exitProg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JavaliVisitor ) return ((JavaliVisitor<? extends T>)visitor).visitProg(this);
