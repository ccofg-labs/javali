...
public interface JavaliListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTipoPrimitivo(JavaliParser.TipoPrimitivoContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaliParser#tipoPrimitivo}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterInteiroDeclaracao(JavaliParser.InteiroDeclaracaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaliParser#inteiroDeclaracao}.
	 * @param ctx the parse tree
	 */
	void exitInteiroDeclaracao(JavaliParser.InteiroDeclaracaoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaliParser#condicaoBoleana}.
	 * @param ctx the parse tree
	 */
	void enterCondicaoBoleana(JavaliParser.CondicaoBoleanaContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaliParser#condicaoBoleana}.
	 * @param ctx the parse tree
	 */
	void exitCondicaoBoleana(JavaliParser.CondicaoBoleanaContext ctx);
	/**
